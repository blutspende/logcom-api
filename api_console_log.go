...
*/
func (a *ConsoleLogApiService) CreateConsoleLogV1Int(ctx context.Context, model CreateConsoleLogRequestDto) (*http.Response, error) {
	var (
...
func (a *ConsoleLogApiService) GetConsoleLogsV1(ctx context.Context, page int32, pageSize int32, localVarOptionals *ConsoleLogApiGetConsoleLogsV1Opts) (ConsoleLogListPageResponse, *http.Response, error) {
	var (
