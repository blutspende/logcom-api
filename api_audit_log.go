...
*/
func (a *AuditLogApiService) CreateAuditLogV1Int(ctx context.Context, model CreateAuditLogRequestDto) (*http.Response, error) {
	var (
...
func (a *AuditLogApiService) GetAuditLogsV1(ctx context.Context, page int32, pageSize int32, localVarOptionals *AuditLogApiGetAuditLogsV1Opts) (AuditLogListPageResponse, *http.Response, error) {
	var (
